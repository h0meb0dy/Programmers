...
1단계부터 7단계까지 차례대로 처리해주면 된다.

입출력 예 5를 보면 6단계에서 16번째 문자인 p를 자르고 나서 끝에 있는 마침표를 제거하는 4단계를 한 번 더 처리해준 것을 확인할 수 있다. 따라서 1단계부터 7단계까지를 더 이상 처리할 게 없을 때까지 반복적으로 거쳐야 한다는 점만 주의하면 된다.
